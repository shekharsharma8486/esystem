<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="EditEvent.aspx.cs" Inherits="EbookingWebProject.EditEvent1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  m = s.getElementsByTagName(o)[0]; a.async = 1; a.src = g; m.parentNode.insertBefore(a, m)
    ...
    <script type="text/javascript">
        function ddltimeselect() {
            if (document.getElementById("<%=txtStartDate.ClientID %>").value == document.getElementById("<%=txtEndDate.ClientID %>").value) {
                ...
                var newckient = document.getElementById("<%=chaddnewpro.ClientID %>");
                ...
                if (newckient.checked == true) {

                }
                if ((ddltimevalue != "Select") && (ddltimevalue != "ddltimevalue2")) {
    ...
    <%--<script type="text/javascript">
        ...
        function myfunction() {
            var e = document.getElementById("<%=ddluser.ClientID %>");
            var ddltext = e.options[e.selectedIndex].text;
            var ddlvalue = e.options[e.selectedIndex].value;

            if (document.getElementById("<%=lblnoti1.ClientID %>").innerHTML) {


                if (document.getElementById("<%=lblnoti2.ClientID %>").innerHTML) {

                    if (document.getElementById("<%=lblnoti3.ClientID %>").innerHTML) {

                        document.getElementById("<%=lblnotilimit.ClientID %>").style.display = "Block";
                    }
                    else {
                        document.getElementById("<%=lblnoti3.ClientID %>").innerHTML = ddltext;
                        // document.getElementById("lblemail3").innerHTML = "( " + ddlvalue + " )";
                        document.getElementById("<%=mail3.ClientID %>").value = ddlvalue;

                        document.getElementById("<%=txtnoti3.ClientID %>").style.display = "Block";
                        document.getElementById("imgcross3").style.display = "Block";

                        document.getElementById("<%=hdnnoti3.ClientID %>").value = ddlvalue;
                    }

                }
                else {
                    document.getElementById("<%=lblnoti2.ClientID %>").innerHTML = ddltext;
                    // document.getElementById("lblemail2").innerHTML = "( " + ddlvalue + " )";
                    document.getElementById("<%=mail2.ClientID %>").value = ddlvalue;
                    document.getElementById("<%=txtnoti2.ClientID %>").style.display = "Block";
                    document.getElementById("imgcross2").style.display = "Block";
                    document.getElementById("<%=hdnnoti2.ClientID %>").value = ddlvalue;
                }

            }
            else {
                document.getElementById("<%=lblnoti1.ClientID %>").innerHTML = ddltext;
                // document.getElementById("lblemail1").innerHTML = "( " + ddlvalue + " )";
                document.getElementById("<%=mail1.ClientID %>").value = ddlvalue;
                document.getElementById("<%=txtnoti1.ClientID %>").style.display = "Block";
                document.getElementById("imgcross1").style.display = "Block";
                document.getElementById("<%=hdnnoti1.ClientID %>").value = ddlvalue;
            }
        ...
        function dlt1() {
            document.getElementById("<%=lblnoti1.ClientID %>").innerHTML = "";
            document.getElementById("<%=txtnoti1.ClientID %>").style.display = "None";
            document.getElementById("imgcross1").style.display = "None";
            document.getElementById("<%=lblnotilimit.ClientID %>").style.display = "None";

            document.getElementById("<%=lblemail1.ClientID %>").style.display = "None";

            document.getElementById("<%=mail1.ClientID %>").value = "";


        }
        function dlt2() {
            document.getElementById("<%=lblnoti2.ClientID %>").innerHTML = "";
            document.getElementById("<%=txtnoti2.ClientID %>").style.display = "None";
            document.getElementById("imgcross2").style.display = "None";
            document.getElementById("<%=lblnotilimit.ClientID %>").style.display = "None";
            document.getElementById("<%=lblemail2.ClientID %>").style.display = "None";
            document.getElementById("<%=mail2.ClientID %>").value = "";


        }
        function dlt3() {
            document.getElementById("<%=lblnoti3.ClientID %>").innerHTML = "";
            document.getElementById("<%=txtnoti3.ClientID %>").style.display = "None";
            document.getElementById("imgcross3").style.display = "None";
            document.getElementById("<%=lblnotilimit.ClientID %>").style.display = "None";
            document.getElementById("<%=lblemail3.ClientID %>").style.display = "None";
            document.getElementById("<%=mail3.ClientID %>").value = "";
    ...
    <script type="text/javascript">
        function check1() {
            ...
            if (Edate) {
                if ((Sdate) && (Edate)) {
                    if (Edate < Sdate) {
                        alert("End Date Should Be Equal Or Grearter Then Start Date");
                        document.getElementById("<%=txtEndDate.ClientID %>").value = "";
                        document.getElementById("<%=txtEndDate.ClientID %>").focus();
                        return false;
                    }
    ...
    <script type="text/javascript">
        function check2() {
            ...
            if (Sdate) {
                if ((Sdate) && (Edate)) {
                    if (Sdate > Edate) {
                        alert("Start Date Should Be Equal Or lesser Then End Date.");
                        document.getElementById("<%=txtStartDate.ClientID %>").value = "";
                        document.getElementById("<%=txtStartDate.ClientID %>").focus();
                        return false;
                    }
    ...
    <script type="text/javascript">
        function ResetEvent() {
            var resetcheck = document.getElementById("<%=ckrestEvent.ClientID %>")
            ...
            if (resetcheck.checked == false) {
                alert("redirect working");
                // window.location = "../UpdateForm.aspx?step=2";
                window.location = "EditEvent.aspx?id=63";
            }
                    ...
                    <script type="text/javascript">
                        ...
                        function clearFileInputField(tagId) {
                            ...
                            if (tagId == 'uploadFile_div') {
                                document.getElementById("<%=lblattach1.ClientID %>").innerHTML = "";
                                document.getElementById("ContentPlaceHolder1_hd1").value = "";
                            ...
                            if (tagId == 'div11') {
                                ...
                                document.getElementById("<%=lblattach2.ClientID %>").innerHTML = "";
                                document.getElementById("ContentPlaceHolder1_hd2").value = "";
                                //document.getElementById("<%=attach2.ClientID %>").disabled = false;
                                select = '2';
                            }
                            if (tagId == 'div222') {
                                document.getElementById("<%=att3.ClientID%>").style.display = "none";
                                document.getElementById("<%=lblattach3.ClientID %>").innerHTML = "";
                                document.getElementById("ContentPlaceHolder1_hd3").value = "";
                                // document.getElementById("<%=attach3.ClientID %>").disabled = false;
                                select = '3';
                            }
                            if (tagId == 'Div3') {
                                document.getElementById("<%=att4.ClientID%>").style.display = "none";
                                document.getElementById("<%=lblattach4.ClientID %>").innerHTML = "";
                                document.getElementById("ContentPlaceHolder1_hd4").value = "";
                            ...
                            var iddd = document.getElementById("<%=HiddenField2.ClientID %>").value;
                            var proid = iddd + "," + select + "";


                            PageMethods.deleteattacgment(proid, onsuccess, onfail);
                    ...
                    <script type="text/javascript">
                        function onckeckchange() {
                            ...
                            if (select.checked == true) {
                                ...
                                document.getElementById("<%=txtEmail.ClientID%>").value = "";
                                document.getElementById("<%=txtPhone.ClientID%>").value = "";
                                //alert(document.getElementById("<%=lblpid.ClientID%>").value = "");
                                //                                document.getElementById("<%=txtFname.ClientID %>").disabled = false;
                                //                                document.getElementById("<%=txtLname.ClientID%>").disabled = false;
                                //                                document.getElementById("<%=txtEmail.ClientID%>").disabled = false;
                                //                                document.getElementById("<%=txtPhone.ClientID%>").disabled = false;
         ...
         function onChangeDiv() {
             ...
             var rbnNew = document.getElementById("<%=rbnAddNewInvoce.ClientID%>");
                            ...
                            if (rbnNew.checked == true) {
                                ...
                                //alert(document.getElementById("<%=hdnAttchInvoice.ClientID%>").value);
    ...
    <script type="text/javascript">
        ...
        function chkk() {
            ...
            var chkrdMainEx = document.getElementById("<%=rdMainEx.ClientID %>");
                        var chkrdInsurance = document.getElementById("<%=rdInsurance.ClientID %>");
                        var chkrdlay = document.getElementById("<%=rdlay.ClientID %>");
                        var rdReminder = document.getElementById("<%=rdReminder.ClientID %>");

                        var txtRDate1 = document.getElementById("<%=txtRDate1.ClientID %>");
                        var txtRDate2 = document.getElementById("<%=txtRDate2.ClientID %>");
                        var txtRDate3 = document.getElementById("<%=txtRDate3.ClientID %>");
                        var txtRDate4 = document.getElementById("<%=txtRDate4.ClientID %>");



                        if (chkrdMainEx.checked == true) {

                            txtRDate1.disabled = false;
                        }
                        else {
                            txtRDate1.disabled = true;
                            txtRDate1.value = "";
                        }

                        if (rdReminder.checked == true) {

                            txtRDate4.disabled = false;
                        }
                        else {
                            txtRDate4.disabled = true;
                            txtRDate4.value = "";
                        }

                        if (chkrdInsurance.checked == true) {
                            txtRDate2.disabled = false;
                        }
                        else {
                            txtRDate2.disabled = true;
                            txtRDate2.value = "";
                        }
                        ...
                        if (chkrdlay.checked == true) {
                            txtRDate3.disabled = false;
                        }
                        else {
                            txtRDate3.disabled = true;
                            txtRDate3.value = "";
                        }
        ...
        function date() {
            var ddlselect = document.getElementById("<%=ddluser.ClientID %>");
                            ...
                            if (txtnotidate > Sdatenoti) {
                                document.getElementById("<%=txtnotidate.ClientID %>").focus();
                                alert("Notification Date Can not be Greater then Event Date");
                                return false;
                    ...
                    <div class="event-col">
                        ...
                        <ContentTemplate>
                                ...
                                <div class="event-col-left-col-1">
                                    ...
                                    <asp:TextBox ID="txtStartDate" Enabled="false" runat="server" autocomplete="off" AutoCompleteType="None"
                                    ...
                                    <div class="clear"></div>
                                    <p>Start Time</p>
                                    <asp:DropDownList ID="ddlstartTime" Width="120px" CssClass="textbox" onChange="return time1()" Enabled="false"
                                        runat="server">
                                    </asp:DropDownList>
                                    ...
                                    <asp:TextBox ID="txtEndDate" runat="server" autocomplete="off" AutoCompleteType="None" Enabled="false"
                                ...
                                <div class="event-col-left-col-2">
                                    ...
                                    <div class="event-col-left-col-2-list">
                                          ...
                                          <asp:Label ID="Label6" runat="server" Text="Reset Event" ForeColor="#52829B" Font-Size="14px"></asp:Label>
                  
                            <asp:CheckBox ID="ckrestEvent" runat="server" AutoPostBack="true" OnCheckedChanged="ckrestEvent_CheckedChanged" />
                      
                                          <asp:LinkButton runat="server" ID="lblmsg" ForeColor="#CC0000" Style="display: none"></asp:LinkButton>
                                ...
                                <div class="event-col-mid-main-col">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            ...
                                            Text="Add Inventory" class="send_btns" OnClick="btnAddInventory_Click" style="color: #fff; font-size: 12px; text-align: center; background: #272f45; line-height: 15px; border: 1px #900 solid; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; padding: 2px 10px; float: left; margin-left: 20px;" />
                                                        </p>
                                                        ...
                                                        <ContentTemplate>
                                                            <div id="divExisingInvoice" runat="server"  style="display: none; margin-left: 20px; width: 100%;">
                                                             <span style="float:right; width:250px; margin-right:50px; margin-bottom:20px;">
                                                                    ...
                                                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span onclick="gettick()" style="background-color: #CCCCCC; cursor: pointer; border: thin solid #666666; padding:5px; float:left;">Attach</span></span>
                                                                <br />
                                                                <br />
                                                                ...
                                                                <asp:Label runat="server" ID="lblattachname" ClientIDMode="Static" ForeColor="#006699"></asp:Label>
                                                            </div>
                                    ...
                                    function ontxtInvoicechange() {
                                        ...
                                        <div class="event-col-Payment-Details-mid-Add-Notification">
                                            ...
                                            <div class="event-col-Payment-Details-mid-Add-Notification-input">
                                                <asp:DropDownList ID="ddluser" CssClass="textbox" AppendDataBoundItems="true" onchange="onddluser();" runat="server" Style="width: 45%; height: 33%; float: left; margin-right: 20px;">
                                                    ...
                                                    <asp:GridView ID="gvuser" runat="server" AllowPaging="True" AutoGenerateColumns="false"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Name">
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" ID="lbluserid" Text='<%#Eval("UserId") %>' Visible="false"></asp:Label>
                                                                ...
                                                                <asp:TemplateField HeaderText="event" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" ID="lbleventid" Text='<%#Eval("EventId") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                            ...
                            <div class="event-col-Payment-Details">
                                <div class="event-col-Payment-Details-head">
                                    ...
                                    <asp:DropDownList runat="server" Style="width: 40%; float: left;" AppendDataBoundItems="true" CssClass="textbox" ID="ddlcurr">
                                        <asp:ListItem Text="USD" Value="USD" >USD</asp:ListItem>
                                        <asp:ListItem Text="Euro" Value="Euro">Euro</asp:ListItem>
                                        <asp:ListItem Text="INR" Value="INR">INR</asp:ListItem>
                                        <asp:ListItem Text="Yen" Value="Yen">Yen</asp:ListItem>
                        ...
                        <ContentTemplate>
                                    ...
                                    <div id="uploadFile_div" class="event-col-mid-clients-mid-col-attachment">
                                      <div class="event-col-mid-clients-mid-col-attachment-left">  1.</div>
                                      <div class="event-col-mid-clients-mid-col-attachment-mid">
                                        <asp:FileUpload ID="attach1" runat="server" Style="color: Blue;" onchange="fileselect();" />
                                        <asp:Label runat="server" ID="lblattach1" ForeColor="#006600"></asp:Label>
                                        <a onclick="clearFileInputField('uploadFile_div')" href="javascript:noAction();" id="att1" runat="server" style="display:none">Clear</a>
                                            </div>
                                    </div>
                                    <div id="div11" class="event-col-mid-clients-mid-col-attachment">
                                         <div class="event-col-mid-clients-mid-col-attachment-left">  2.</div>
                                           <div class="event-col-mid-clients-mid-col-attachment-mid">
                                        <asp:FileUpload ID="attach2" runat="server" Style="color: Blue;" onchange="fileselect2();"/>
                                        <asp:Label runat="server" ID="lblattach2" ForeColor="#006600" ></asp:Label>
                                        <a onclick="clearFileInputField('div11')" href="javascript:noAction();" id="att2" runat="server" style="display:none">Clear</a>
                                    </div></div>
                                    <div id="div222" class="event-col-mid-clients-mid-col-attachment">
                                           <div class="event-col-mid-clients-mid-col-attachment-left">  3.</div>
                                             <div class="event-col-mid-clients-mid-col-attachment-mid">
                                        <asp:FileUpload ID="attach3" runat="server" Style="color: Blue;" onchange="fileselect3();" />
                                        <asp:Label runat="server" ID="lblattach3" ForeColor="#006600" ></asp:Label>
                                        <a onclick="clearFileInputField('div222')" href="javascript:noAction();" id="att3" runat="server" style="display:none">Clear</a>
                                    </div></div>
                                    <div id="Div3" class="event-col-mid-clients-mid-col-attachment">
                                           <div class="event-col-mid-clients-mid-col-attachment-left">  4.</div>
                                             <div class="event-col-mid-clients-mid-col-attachment-mid">
                                        <asp:FileUpload ID="attach4" runat="server" Style="color: Blue;" onchange="fileselect4();" />
                                        <asp:Label runat="server" ID="lblattach4" ForeColor="#006600" ></asp:Label>
                                        <a onclick="clearFileInputField('Div3')" href="javascript:noAction();" id="att4" runat="server" style="display:none">Clear</a>
                                    </div></div>
                                    ...
                                    <div class="event-col-Payment-Details-mid-Add-Notes">
                                        ...
                                        <div class="event-col-Payment-Details-mid-Add-Notes-button">
                                            <div class="event-col-more">
                                                    <asp:Button runat="server"  Width="250px" ID="btndone" Text="Update"
                                            OnClientClick="return validatedata();" OnClick="btndone_Click" style=" color: #fff; font-size: 12px; text-align: center; background: #272f45; line-height: 15px; border: 1px #900 solid; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; padding: 2px 10px; float: left; margin-left: 20px; width:100px;" />
...
<%--                                                <asp:Button ID="btndone1" runat="server" Text="Submit" Style="color: #fff; font-size: 12px; text-align: center; background: #272f45; line-height: 15px; border: 1px #900 solid; -moz-border-radius: 5px; -webkit-border-radius: 5px; border-radius: 5px; padding: 2px 10px; float: left; margin-left: 20px;" OnClientClick="return validatedata();"
    ...
    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server" Width="50%" Height="45%" CssClass="ModalWindow"
                Style="overflow-y: scroll;">
                <asp:Button runat="server" ID="btnModalPopUp" Style="display: none" />
                <asp:ImageButton ID="lnkOk" runat="server" Style="float: right; border: 1px solid black;"
                    src="img/cross_icon.png" Height="15px" Width="15px" />
                <asp:Label ID="lblEventName" runat="server" Text="" Font-Size="Medium" ForeColor="Blue"></asp:Label>
                <asp:GridView ID="grdInventInfo" runat="server" AutoGenerateColumns="false" Width="100%"
                    BackColor="White" BorderColor="#336699" EmptyDataText="No Record Found.." BorderStyle="Solid"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Event Title">
                            <ItemTemplate>
                                <ul class="tabs">
                                    <li><a href="Details.aspx?id=<%#Eval("id")%>" class="current">
                                        <%#Eval("Event_Title")%></a></li>
                                    <%--<a href="#">
                                            <img src="img/pin_icon.png" alt=""></a>--%>
                                </ul>
                                <%--   <asp:Label ID="Label6" runat="server" Text='<%#Eval("Event_Title") %>'></asp:Label>--%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Start Time">
                            <ItemTemplate>
                                <asp:Label ID="Label9" runat="server" Text='<%#Eval("StartTime") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="End Time">
                            <ItemTemplate>
                                <asp:Label ID="Label10" runat="server" Text='<%#Eval("EndTime") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <%--<asp:ModalPopupExtender TargetControlID="btnModalPopUp" ID="ModalPopupExtender2"
        runat="server" BackgroundCssClass="modalBackground" PopupControlID="Panel1" OkControlID="lnkOk" />--%>
            <asp:ModalPopupExtender TargetControlID="btnModalPopUp" ID="ModalPopupExtender2"
                runat="server" BackgroundCssClass="modalBackground" PopupControlID="Panel1" OkControlID="lnkOk">
            </asp:ModalPopupExtender>
        </ContentTemplate>
        <Triggers>
            <asp:PostBackTrigger ControlID="chklistgrnd" />
        </Triggers>
    </asp:UpdatePanel>
    <style type="text/css">
        .modalBackground
